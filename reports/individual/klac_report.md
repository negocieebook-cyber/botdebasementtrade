...
- Invalidacao abaixo de 1425.85.
- Regime macro: supportive.
- Padrão de acumulação por volume: dias de alta com volume maior que dias de baixa.
- Força relativa positiva vs benchmark da classe (+17.5pp nos últimos 63 dias).
...
- score: 92.0
- tone: bullish
- notes: +28 positive signals in 20 headlines; 12/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 2060.08, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
