...
- Invalidacao abaixo de 523.99.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+3.5pp nos últimos 63 dias).
...
- score: 75.0
- tone: bullish
- notes: +27 positive signals in 20 headlines; -3 negative signals in 20 headlines; 1/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 715.83, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
