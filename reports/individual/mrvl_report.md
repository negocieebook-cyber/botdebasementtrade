...
- Invalidacao abaixo de 76.59.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+136.5pp nos últimos 63 dias).
...
- score: 85.0
- tone: bullish
- notes: +29 positive signals in 20 headlines; -1 negative signals in 20 headlines; 7/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 218.26, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
