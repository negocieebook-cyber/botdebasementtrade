...
- Invalidacao abaixo de 67.08.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+17.6pp nos últimos 63 dias).
...
- score: 85.9
- tone: bullish
- notes: +27 positive signals in 20 headlines; -1 negative signals in 20 headlines; 8/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 77.16, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
