...
- Invalidacao abaixo de 461.07.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+55.6pp nos últimos 63 dias).
...
- score: 76.8
- tone: bullish
- notes: +18 positive signals in 20 headlines; -1 negative signals in 20 headlines

## Gatilho de confirmação
Confirmacao acima de 605.61, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
