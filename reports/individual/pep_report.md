...
- score: 0.0
- regime: hostile
- notes: No intermarket rule for asset_class=defensive_dividends.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Fora do padrão; score 19/100.
