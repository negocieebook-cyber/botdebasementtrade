...
- Invalidacao abaixo de 111.91.
- Regime macro: supportive.
- Padrão de acumulação por volume: dias de alta com volume maior que dias de baixa.
- Força relativa positiva vs benchmark da classe (+138.9pp nos últimos 63 dias).
...
- tone: bullish
- notes: +31 positive signals in 20 headlines; -4 negative signals in 20 headlines; 3/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 312.14, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
