...
- Invalidacao abaixo de 28.25.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+9.1pp nos últimos 63 dias).
...
- score: 62.0
- tone: neutral
- notes: +7 positive signals in 4 headlines; -3 negative signals in 4 headlines

## Gatilho de confirmação
Confirmacao acima de 34.07, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
