...
- Invalidacao abaixo de 52.05.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+3.0pp nos últimos 63 dias).
...
- score: 70.7
- tone: bullish
- notes: +21 positive signals in 20 headlines; -6 negative signals in 20 headlines; 4/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 61.24, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
