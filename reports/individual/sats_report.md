...
- Invalidacao abaixo de 105.57.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+5.3pp nos últimos 63 dias).
...
- score: 75.7
- tone: bullish
- notes: +17 positive signals in 20 headlines; -2 negative signals in 20 headlines; 2/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 147.25, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
