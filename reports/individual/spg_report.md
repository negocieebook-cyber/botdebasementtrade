...
- Invalidacao abaixo de 196.01.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+1.5pp nos últimos 63 dias).
...
- score: 50.0
- regime: mixed
- notes: +5.0: VNQ rising (trend score 5.0/5).; +0.0: 10Y yield ^TNX falling favors REITs (falling trend score 0.0/5).

## Narrativa
- score: 91.19999999999999
- tone: bullish
- notes: +15 positive signals in 20 headlines; -1 negative signals in 20 headlines; 15/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 208.79, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 50/100.
