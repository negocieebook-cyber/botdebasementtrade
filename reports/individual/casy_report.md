...
- Invalidacao abaixo de 650.55.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+7.0pp nos últimos 63 dias).
...
- score: 82.0
- tone: bullish
- notes: +19 positive signals in 20 headlines; -1 negative signals in 20 headlines; 5/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 901.00, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
