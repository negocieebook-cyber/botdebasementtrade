...
- Invalidacao abaixo de 51.98.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+23.5pp nos últimos 63 dias).
...
- score: 73.3
- tone: bullish
- notes: +26 positive signals in 20 headlines; -7 negative signals in 20 headlines; 6/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 85.18, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
