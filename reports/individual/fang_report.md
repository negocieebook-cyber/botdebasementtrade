...
- Invalidacao abaixo de 160.81.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+7.1pp nos últimos 63 dias).
...
- score: 74.5
- tone: bullish
- notes: +19 positive signals in 20 headlines; -5 negative signals in 20 headlines; 7/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 213.34, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 23/100.
