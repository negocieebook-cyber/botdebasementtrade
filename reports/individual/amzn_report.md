...
- Invalidacao abaixo de 202.48.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+9.2pp nos últimos 63 dias).
...
- score: 85.5
- tone: bullish
- notes: +28 positive signals in 20 headlines; -4 negative signals in 20 headlines; 13/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 278.56, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
