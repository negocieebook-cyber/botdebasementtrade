...
- Invalidacao abaixo de 31.67.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+4.8pp nos últimos 63 dias).
...
- score: 56.5
- tone: neutral
- notes: +14 positive signals in 17 headlines; -9 negative signals in 17 headlines

## Gatilho de confirmação
Confirmacao acima de 35.47, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
