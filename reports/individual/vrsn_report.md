...
- Invalidacao abaixo de 240.88.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+29.0pp nos últimos 63 dias).
...
- score: 76.8
- tone: bullish
- notes: +22 positive signals in 20 headlines; -3 negative signals in 20 headlines; 4/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 312.48, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
