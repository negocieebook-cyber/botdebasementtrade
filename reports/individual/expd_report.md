...
- Invalidacao abaixo de 138.59.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+4.7pp nos últimos 63 dias).
...
- score: 64.4
- tone: neutral
- notes: +29 positive signals in 20 headlines; -12 negative signals in 20 headlines; 2/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 163.10, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
