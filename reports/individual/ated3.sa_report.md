...
- Invalidacao abaixo de 2.06.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+15.3pp nos últimos 63 dias).
...
Confirmacao acima de 2.43, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Fora do padrão; score 31/100.
