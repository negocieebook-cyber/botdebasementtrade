...
- Invalidacao abaixo de 274.29.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+30.2pp nos últimos 63 dias).
...
- score: 75.1
- tone: bullish
- notes: +18 positive signals in 20 headlines; -4 negative signals in 20 headlines; 6/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 399.59, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 35/100.
