...
- Invalidacao abaixo de 323.13.
- Regime macro: supportive.
- Intermarket favorável.
- Força relativa positiva vs benchmark da classe (+44.2pp nos últimos 63 dias).
...
- score: 76.0
- tone: bullish
- notes: +20 positive signals in 20 headlines; -5 negative signals in 20 headlines; 8/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 584.50, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
