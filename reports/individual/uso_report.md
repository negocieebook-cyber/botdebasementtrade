...
- Invalidacao abaixo de 74.46.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+45.2pp nos últimos 63 dias).
...
- score: 53.8
- tone: neutral
- notes: +5 positive signals in 20 headlines; -11 negative signals in 20 headlines; 15/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 154.08, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
