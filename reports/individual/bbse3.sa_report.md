...
- Invalidacao abaixo de 33.85.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+8.0pp nos últimos 63 dias).
...
- score: 66.7
- tone: bullish
- notes: +28 positive signals in 19 headlines; -8 negative signals in 19 headlines

## Gatilho de confirmação
Confirmacao acima de 35.39, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
