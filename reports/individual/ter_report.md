...
- Invalidacao abaixo de 300.29.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+0.5pp nos últimos 63 dias).
...
- score: 86.1
- tone: bullish
- notes: +31 positive signals in 20 headlines; -1 negative signals in 20 headlines; 8/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 406.65, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
