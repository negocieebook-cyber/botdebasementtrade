...
- Invalidacao abaixo de 206.01.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+6.9pp nos últimos 63 dias).
...
- score: 83.9
- tone: bullish
- notes: +32 positive signals in 20 headlines; -3 negative signals in 20 headlines; 9/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 237.41, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
