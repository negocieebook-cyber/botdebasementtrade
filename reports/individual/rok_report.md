...
- Invalidacao abaixo de 398.87.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+4.5pp nos últimos 63 dias).
...
- score: 66.7
- tone: bullish
- notes: +16 positive signals in 20 headlines; -5 negative signals in 20 headlines; 1/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 462.06, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
