...
- Invalidacao abaixo de 136.85.
- Regime macro: supportive.
- Intermarket favorável.
- Força relativa positiva vs benchmark da classe (+20.0pp nos últimos 63 dias).
...
- score: 60.5
- tone: neutral
- notes: +15 positive signals in 20 headlines; -9 negative signals in 20 headlines; 3/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 186.26, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
