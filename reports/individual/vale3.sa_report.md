...
- Invalidacao abaixo de 77.41.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+3.1pp nos últimos 63 dias).
...
- score: 79.6
- tone: bullish
- notes: +16 positive signals in 20 headlines; -6 negative signals in 20 headlines; 16/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 85.41, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
