...
- Invalidacao abaixo de 1091.01.
- Regime macro: supportive.
- Padrão de acumulação por volume: dias de alta com volume maior que dias de baixa.
- Força relativa positiva vs benchmark da classe (+19.7pp nos últimos 63 dias).
...
- score: 0.0
- regime: hostile
- notes: No intermarket rule for asset_class=us_core_stocks.

## Narrativa
- score: 73.89999999999999
- tone: bullish
- notes: +30 positive signals in 20 headlines; -4 negative signals in 20 headlines; 1/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 2073.18, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 30/100.
