...
## Pontos a favor
- Invalidacao abaixo de 5.70.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+2.2pp nos últimos 63 dias).
...
- score: 68.0
- tone: bullish
- notes: +4 positive signals in 2 headlines; -1 negative signals in 2 headlines

## Gatilho de confirmação
Confirmacao acima de 6.39, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
