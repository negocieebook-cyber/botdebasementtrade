...
- Invalidacao abaixo de 51.19.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+9.6pp nos últimos 63 dias).
...
- score: 74.0
- tone: bullish
- notes: +32 positive signals in 20 headlines; -8 negative signals in 20 headlines; 6/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 61.58, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
