...
- Invalidacao abaixo de 230.11.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+11.8pp nos últimos 63 dias).
...
- score: 79.2
- tone: bullish
- notes: +23 positive signals in 20 headlines; -2 negative signals in 20 headlines; 4/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 262.50, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
