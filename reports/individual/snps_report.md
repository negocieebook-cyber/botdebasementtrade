...
- Invalidacao abaixo de 405.71.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+7.9pp nos últimos 63 dias).
...
- score: 72.4
- tone: bullish
- notes: +17 positive signals in 20 headlines; -5 negative signals in 20 headlines; 6/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 539.48, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
