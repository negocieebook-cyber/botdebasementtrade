...
Entrou no radar como Acumulação inicial porque combina queda relevante para a classe, score 52/100 e sinais técnicos como suporte, médias, RSI, MACD ou compressão de volatilidade.
...
- score: 0.0
- regime: hostile
- notes: No intermarket rule for asset_class=brazil_etfs.
...
Confirmacao acima de 53.00, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo permanece no radar como Acumulação inicial, com score 52/100, aguardando confirmação e respeitando o ponto de invalidação.
