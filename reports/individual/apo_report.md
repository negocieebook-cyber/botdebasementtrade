...
- Invalidacao abaixo de 127.82.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+2.4pp nos últimos 63 dias).
...
- score: 74.0
- tone: bullish
- notes: +17 positive signals in 20 headlines; -3 negative signals in 20 headlines; 3/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 136.01, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
