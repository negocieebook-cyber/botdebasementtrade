...
- Invalidacao abaixo de 49.95.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+43.4pp nos últimos 63 dias).
...
Confirmacao acima de 77.77, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Fora do padrão; score 29/100.
