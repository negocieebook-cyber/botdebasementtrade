...
- Invalidacao abaixo de 540.14.
- Regime macro: supportive.
- Padrão de acumulação por volume: dias de alta com volume maior que dias de baixa.
- Força relativa positiva vs benchmark da classe (+142.3pp nos últimos 63 dias).
...
- score: 82.0
- tone: bullish
- notes: +22 positive signals in 20 headlines; -2 negative signals in 20 headlines; 7/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 1658.77, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
