...
- score: 65.0
- regime: mixed
- notes: +5.0: EEM/KWEB proxy rising (trend score 5.0/5).; +1.5: Dollar proxy UUP falling (falling trend score 1.5/5).

## Narrativa
- score: 84.0
- tone: bullish
- notes: +5 positive signals in 10 headlines; -1 negative signals in 10 headlines; 7/10 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 104.16, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
