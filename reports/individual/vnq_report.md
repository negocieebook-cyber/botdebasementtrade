...
- Invalidacao abaixo de 88.30.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+0.7pp nos últimos 63 dias).
...
- score: 69.7
- tone: bullish
- notes: +11 positive signals in 20 headlines; -8 negative signals in 20 headlines; 15/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 97.71, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
