...
- Invalidacao abaixo de 124.57.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+10.0pp nos últimos 63 dias).
...
- score: 74.3
- tone: bullish
- notes: +26 positive signals in 20 headlines; -7 negative signals in 20 headlines; 7/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 211.79, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 31/100.
