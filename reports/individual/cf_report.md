...
- Invalidacao abaixo de 91.78.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+12.3pp nos últimos 63 dias).
...
- score: 71.7
- tone: bullish
- notes: +24 positive signals in 20 headlines; -5 negative signals in 20 headlines; 2/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 129.90, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
