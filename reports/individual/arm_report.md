...
- Invalidacao abaixo de 119.70.
- Regime macro: supportive.
- Padrão de acumulação por volume: dias de alta com volume maior que dias de baixa.
- Força relativa positiva vs benchmark da classe (+120.6pp nos últimos 63 dias).
...
- score: 81.0
- tone: bullish
- notes: +27 positive signals in 20 headlines; -3 negative signals in 20 headlines; 7/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 325.00, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
