...
Entrou no radar como Acumulação inicial porque combina queda relevante para a classe, score 56/100 e sinais técnicos como suporte, médias, RSI, MACD ou compressão de volatilidade.
...
Confirmacao acima de 2.23, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo permanece no radar como Acumulação inicial, com score 56/100, aguardando confirmação e respeitando o ponto de invalidação.
