...
- Invalidacao abaixo de 32.35.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+3.7pp nos últimos 63 dias).
...
- score: 54.6
- tone: neutral
- notes: +10 positive signals in 20 headlines; -9 negative signals in 20 headlines; 3/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 43.59, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
