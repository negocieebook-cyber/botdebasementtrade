...
- Invalidacao abaixo de 246.32.
- Regime macro: supportive.
- Intermarket favorável.
- Força relativa positiva vs benchmark da classe (+9.3pp nos últimos 63 dias).
...
- score: 73.8
- tone: bullish
- notes: +19 positive signals in 20 headlines; -7 negative signals in 20 headlines; 10/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 301.82, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
