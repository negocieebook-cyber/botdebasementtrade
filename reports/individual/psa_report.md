...
- Invalidacao abaixo de 289.21.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+1.0pp nos últimos 63 dias).
...
- score: 73.4
- tone: bullish
- notes: +24 positive signals in 20 headlines; -4 negative signals in 20 headlines; 2/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 313.12, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
