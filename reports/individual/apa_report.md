...
- Invalidacao abaixo de 24.81.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+23.2pp nos últimos 63 dias).
...
- score: 74.2
- tone: bullish
- notes: +14 positive signals in 20 headlines; -5 negative signals in 20 headlines; 10/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 42.09, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
