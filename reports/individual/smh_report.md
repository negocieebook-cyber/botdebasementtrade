...
- Invalidacao abaixo de 380.87.
- Regime macro: supportive.
- Intermarket favorável.
- Força relativa positiva vs benchmark da classe (+30.6pp nos últimos 63 dias).
...
## Narrativa
- score: 78.60000000000001
- tone: bullish
- notes: +25 positive signals in 20 headlines; -3 negative signals in 20 headlines; 5/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 612.30, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
