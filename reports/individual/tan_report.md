...
- Força relativa positiva vs benchmark da classe (+9.7pp nos últimos 63 dias).
...
- score: 64.6
- tone: neutral
- notes: +27 positive signals in 20 headlines; -11 negative signals in 20 headlines; 2/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 71.31, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
