...
- Invalidacao abaixo de 70.71.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+0.9pp nos últimos 63 dias).
...
- score: 73.4
- tone: bullish
- notes: +21 positive signals in 20 headlines; -4 negative signals in 20 headlines; 3/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 88.44, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
