...
- Invalidacao abaixo de 65.34.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+3.8pp nos últimos 63 dias).
...
- score: 64.5
- tone: neutral
- notes: +4 positive signals in 11 headlines; -4 negative signals in 11 headlines; 8/11 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 67.25, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
