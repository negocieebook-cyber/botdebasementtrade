...
- Invalidacao abaixo de 58.28.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+70.1pp nos últimos 63 dias).
...
## Narrativa
- score: 82.89999999999999
- tone: bullish
- notes: +30 positive signals in 20 headlines; -4 negative signals in 20 headlines; 10/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 129.13, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 36/100.
