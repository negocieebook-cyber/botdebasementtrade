...
- Invalidacao abaixo de 257.93.
- Regime macro: supportive.
- Intermarket favorável.
- Força relativa positiva vs benchmark da classe (+0.8pp nos últimos 63 dias).
...
- score: 100.0
- regime: supportive
- notes: +5.0: SPY rising (trend score 5.0/5).; +5.0: VIX proxy ^VIX falling (falling trend score 5.0/5).

## Narrativa
- score: 71.5
- tone: bullish
- notes: +10 positive signals in 20 headlines; -6 negative signals in 20 headlines; 14/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 291.72, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Alerta bearish — padrao de topo; score 52/100.
