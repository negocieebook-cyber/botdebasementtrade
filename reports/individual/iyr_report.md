...
- Invalidacao abaixo de 94.15.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+0.1pp nos últimos 63 dias).
...
- score: 70.0
- tone: bullish
- notes: +1 positive signals in 2 headlines; -1 negative signals in 2 headlines; 2/2 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 103.63, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
