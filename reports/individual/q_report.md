...
Not on radar: insufficient history.

## Pontos a favor
- None.

## Pontos contra
- Insufficient history for the class threshold.
...
- score: 76.7
- tone: bullish
- notes: +25 positive signals in 20 headlines; -4 negative signals in 20 headlines; 5/20 theme-relevant headlines found
...
## Conclusão
O ativo não passa no filtro principal nesta leitura. Fase atual: Fora do padrão; score 0/100.
