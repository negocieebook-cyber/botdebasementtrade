...
- Invalidacao abaixo de 790.14.
- Regime macro: supportive.
- Força relativa positiva vs benchmark da classe (+8.7pp nos últimos 63 dias).
...
- score: 75.4
- tone: bullish
- notes: +24 positive signals in 20 headlines; -4 negative signals in 20 headlines; 4/20 theme-relevant headlines found

## Gatilho de confirmação
Confirmacao acima de 1125.43, idealmente com fechamento sustentado e volume igual ou acima da media de 30 dias.
